...
import com.rockies.mapper.RoomTypeInfoMapper;
...
public class RoomTypeInfoServiceImpl implements IRoomTypeInfoService {
	...
	@Override
	public List<Map<String, Object>> selectRoomPriceByParam(Map<String, Object> param) {
		return roomTypeInfoMapper.selectRoomPriceByParam(param);
	}
