...
import com.rockies.mapper.TrafficCharteredPriceInfoMapper;
...
public class TrafficCharteredPriceInfoServiceImpl implements ITrafficCharteredPriceInfoService {
	...
	@Override
	public TrafficCharteredPriceInfo selectTrafficCharteredPriceInfoById(int id) {
		return trafficCharteredPriceInfoMapper.selectTrafficCharteredPriceInfoById(id);
	}

	@Override
	public List<TrafficCharteredPriceInfo> selectPriceInfo(Map<String, Object> param) {
		return trafficCharteredPriceInfoMapper.selectPriceInfo(param);
	}
