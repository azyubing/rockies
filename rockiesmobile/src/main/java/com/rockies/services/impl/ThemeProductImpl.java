...
import com.rockies.mapper.ThemeProductMapper;
import com.rockies.model.ThemeCatalog;
import com.rockies.model.ThemeProduct;
import com.rockies.services.IThemeProductService;
...
public class ThemeProductImpl implements IThemeProductService {
    ...
    @Override
    public List<Map<String, Object>> getThemeproductListMapBythemeId(Map<String, Object> param) {
//        return themeProductMapper.getThemeproductListMapBythemeId(param);
        return themeProductMapper.getThemeproductListMapBythemeId2(param);
    }

	@Override
	public List<Map<String, Object>> getThemeProductDetailListMap(Map<String, Object> param) {
		return themeProductMapper.getThemeProductDetailListMap(param);
	}

	@Override
	public List<Map<String, Object>> getThemeProductCityList(Map<String, Object> param) {
		return themeProductMapper.getThemeProductCityList(param);
	}
