...
import com.rockies.mapper.VillaDetailPriceInfoMapper;
...
public class VillaDetailPriceInfoServiceImpl implements IVillaDetailPriceInfoService {
	...
	@Override
	public VillaDetailPriceInfo selectVillaDetailPriceInfoById(int id) {
		return villaDetailPriceInfoMapper.selectVillaDetailPriceInfoById(id);
	}

	@Override
	public List<PackagePriceInfo> getVillaPriceCal(Map<String, Object> param) {
		return villaDetailPriceInfoMapper.getVillaPriceCal(param);
	}
