...
public class ProductOrderDetail extends BaseModel {
	...
	public String toString() {
		return "ProductOrderDetail [orderNo=" + orderNo + ", runingNo="
				+ runingNo + ", priceItemId=" + priceItemId + ", priceItem="
				+ priceItem + ", pid=" + pid + ", ordercnt=" + ordercnt
				+ ", unitPrice=" + unitPrice + ", unitPrepay=" + unitPrepay
				+ ", peoplecnt=" + peoplecnt + ", amount=" + amount
