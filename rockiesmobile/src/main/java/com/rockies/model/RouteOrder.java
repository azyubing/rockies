...
public class RouteOrder extends BaseModel {
	...
	private String status;//订单状态      1:待预付  2：已预付（待处理） 3：待付尾款  4：待出行  5：已出行
	...
	private String pingOrderNo;
	private Double oldAmount;//原来总价
	private int travelPartners;
	...
	public String getPingOrderNo() {
		return pingOrderNo;
	}
	public void setPingOrderNo(String pingOrderNo) {
		this.pingOrderNo = pingOrderNo;
	}
	...
	public String toString() {
		return "RouteOrder [orderNo=" + orderNo + ", cusNo=" + cusNo
				...
				+ ", routeEmail=" + routeEmail + ", pingOrderNo=" + pingOrderNo
				+ ", oldAmount=" + oldAmount + "]";
	}
	public int getTravelPartners() {
		return travelPartners;
	}
	public void setTravelPartners(int travelPartners) {
		this.travelPartners = travelPartners;
	}
