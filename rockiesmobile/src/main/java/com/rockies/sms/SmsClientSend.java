...
public class SmsClientSend {
	...
	public static String sendSms(String mobile, String content) {
		String url = CommonUtils.getInterfaceConfigBykey("sms_url");
		String userid = CommonUtils.getInterfaceConfigBykey("sms_id");
		String account = CommonUtils.getInterfaceConfigBykey("sms_account");
		String password = CommonUtils.getInterfaceConfigBykey("sms_pwd");

		//String url = "http://www.591duanxin.com/sms.aspx";
		//String userid = "594";
		//String account = "yancheng106";
