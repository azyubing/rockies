...
<div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li>
				<span style="color: #669FC7;">娱乐行程详细新增</span>
			</li>
		</ul>
...
<div class="page-content">
	<div class="page-content-area">
        <div class="row">
			<div class="col-md-12">
				<h3 class="header smaller lighter blue">娱乐行程详细新增</h3>
				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<form action="<%=basePath%>ent/addEntRouteDetailAdmin.html" id="addForm" name="addForm" method="post">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<input id="pday" name="pday" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
