				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<form action="<%=basePath%>ent/addEntPriceAdmin.html" id="addForm" name="addForm" method="post">
									...
									<div class="col-md-6">
										...
										<div style="display: inline-block; width: 50%;">
											<div class="input-group "  >
												<input id="starttime" name="starttime" onblur="checkStartTimeRepeat()" class="form-control date-picker" type="text"  />
								...
								<div class="row">
									...
									<div class="col-md-6">
										<label class=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;结束时间：</label>
										<input id="enddate" name="enddate" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
										<span style="color: red;">*输入的时间格式如:09:30</span>
									</div>
								</div>
								 -->
...
<script type="text/javascript">
	...
	function checkStartTimeRepeat(){
		...
		$.ajax({
			type:"GET",
			url:"<%=basePath%>ent/checkEntPriceStartTimeRepeat.html",
			data:{'pid': $("#pid").val(),'starttime': $("#starttime").val() },
			dataType: "html",
