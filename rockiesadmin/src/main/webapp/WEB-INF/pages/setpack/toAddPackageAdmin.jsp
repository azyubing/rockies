				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<form action="<%=basePath%>setpack/addPackageAdmin.html" id="addForm" name="addForm" method="post">
								<%-- 基础信息 --%>
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<select id="property" name="property" class="form-control"  style="display: inline-block; width: 50%;"/>  
											<option value="" >-请选择-</option>
											<option value="1" >一地</option>
											<option value="2" >多地</option>
						                </select>
									</div>
								</div>
								<br>
								<div class="row">
									<div class="col-md-6">
										...
										<div style="display: inline-block;   position: relative; top: 8px;">
											<input id="daycnt" name="daycnt" type="text" class="input-mini spinner3" value="0" />
										</div>
									</div>
									<div class="col-md-6">
