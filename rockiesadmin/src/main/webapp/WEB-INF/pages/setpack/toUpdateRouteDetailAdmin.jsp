...
<div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li>
				<span style="color: #669FC7;">套餐行程详细修改</span>
			</li>
		</ul>
...
<div class="page-content">
	<div class="page-content-area">
        <div class="row">
			<div class="col-md-12">
				<h3 class="header smaller lighter blue">套餐行程详细修改</h3>
				<div class="panel panel-default">
					  ...
					  <div class="panel-body">
					  		<div class="row">
					  			<div class="col-md-4"><label>套餐行程日：</label>第${res.pday }天</div>
					  			<div class="col-md-4"><label>套餐行程纬度：</label>${res.mapLat }</div>
					  			<div class="col-md-4"><label>套餐行程经度：</label>${res.mapLng }</div>
					  		</div>
					  </div>
				</div>
			</div>
				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<form action="<%=basePath%>setpack/updateRouteDetailAdmin.html" id="updateForm" name="updateForm" method="post">
