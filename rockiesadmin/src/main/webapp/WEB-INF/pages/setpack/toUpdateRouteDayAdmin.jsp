			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					  ...
					  <div class="panel-body">
					  		<div class="row">
					  			<div class="col-md-4"><label>套餐名称：</label>${res.pname }</div>
					  			<div class="col-md-4"><label>套餐英文名：</label>${res.pname_en }</div>
					  			<div class="col-md-4"><label>套餐编号：</label>${res.pid }</div>
					  		</div>
					  </div>
				</div>
			</div>
				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<form action="<%=basePath%>setpack/updateRouteDayAdmin.html" id="updateForm" name="updateForm" method="post">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<input id="tabs" name="tabs" value="${row.tabs }" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
										<span style="color: red;">*多个标签用|隔开。</span>
									</div>
									<div class="col-md-6">
										<label class=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地图地址： </label>
										<input id="mapAddress" name="mapAddress" value="${row.mapAddress }" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
								</div>
								<br>
								<div class="row">
									<div class="col-md-6">
										...
										<input id="mapLat" name="mapLat" value="${row.mapLat }" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
										<a href="http://www.google.cn/maps/" target="_blank" alt="哈哈">点击获取经纬度</a>
									</div>
									<div class="col-md-6">
										<label class=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地图经度： </label>
										<input id="mapLng" name="mapLng" value="${row.mapLng }" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
								</div>
								<br>
								<div class="row">
...
<script type="text/javascript">
	...
	$(function() { 
		...
		attachedImgPreview('${row.img1}');
		
		$("#attachedImgurl").val('${row.img1}');
