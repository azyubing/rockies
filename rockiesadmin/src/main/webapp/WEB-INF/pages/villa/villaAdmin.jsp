...
<div class="page-content">
	<div class="page-content-area">
        <div class="row">
			<div class="col-md-12">
				<h3 class="header smaller lighter blue">别墅管理</h3>
...
function operateFormatter(value, row, index) { 
	return [
			...
			'</a>',
	        '<a class="edit margin-left-20" href="javascript:void(0)" title="add room" id="toSetVillaDetailPriceAdmin">',
...
window.operateEvents = {
        ...
        'click #toSetVillaDetailPriceAdmin': function (e, value, row, index) {
			window.location.href='<%=basePath%>villa/toSetVillaDetailPriceAdmin.html?menu=${menu}&pid='+row.pid;
        },
        'click #detailBtn': function (e, value, row, index) {
        	window.location.href='<%=basePath%>villa/toUpdateVillaAdmin.html?menu=${menu}&pid='+row.pid;
        },
        'click #deleteBtn': function (e, value, row, index) {
			$.messager.confirm("提示", "是否确认删除:"+row.pname, function() {
				...
				$.ajax({
					type:"POST",
					url:"<%=basePath%>villa/deleteVillaAdmin.html",
					data:{'pid': row.pid},
					dataType: "html",
					success: function(json){
						$('#tableInfo').bootstrapTable('refresh',{url: "<%=basePath%>villa/villaAdminSearchList.html"});
...
function doSearch(){
    		...
    		var url = "<%=basePath%>villa/villaAdminSearchList.html";
	...
	$(function() { 
		...
		$("#addBtn").click(function(){
			window.location.href = '<%=basePath%>villa/toAddVillaAdmin.html?menu=${menu}';
		});
