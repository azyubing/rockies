				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<form action="<%=basePath%>villa/addVillaAdmin.html" id="addForm" name="addForm" method="post">
								<%-- 基础信息 --%>
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<select id="geography" name="geography" class="form-control"  style="display: inline-block; width: 50%;"/>  
											...
											<option value="0" >沙滩</option>
											<option value="1" >花园</option>
											<option value="2" >半山</option>
											<option value="3" >山顶</option>
						                </select>
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div style="display: inline-block;   position: relative; top: 8px;">
											<input id="minroomcnt" name="minroomcnt" type="text" class="input-mini spinner3" value="0" />
										</div>
									</div>
									<div class="col-md-6">
										<label class=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;最大房间数 ： </label>
										<div style="display: inline-block;   position: relative; top: 8px;">
											<input id="maxroomcnt" name="maxroomcnt" type="text" class="input-mini spinner3" value="0" />
										</div>
									</div>
								</div>
								<br>
								<div class="row">
									<div class="col-md-12">
										...
										<textarea id="service" name="service" class="form-control" rows="3"  style="width: 83%;margin-left: 25px;"></textarea>
									</div>
								</div>
								<br>
