...
<div class="page-content">
	<div class="page-content-area">
        <div class="row">
			<div class="col-md-12">
				<h3 class="header smaller lighter blue">酒店管理</h3>
...
function operateFormatter(value, row, index) { 
	return [
	        <%--'<a class="edit margin-left-20" href="javascript:void(0)" title="set tag" id="setTagBtn">',
			...
			'</a>',
	        '<a class="edit margin-left-20" href="javascript:void(0)" title="add room" id="addRoomBtn">',
	            '<i class="glyphicon glyphicon-edit"></i> 添加房间',
	        '</a>',
...
window.operateEvents = {
        ...
        'click #addRoomBtn': function (e, value, row, index) {
			window.location.href='<%=basePath%>/hotel/toSetRoomAdmin.html?menu=${menu}&pid='+row.pid;
        },
        'click #detailBtn': function (e, value, row, index) {
        	window.location.href='<%=basePath%>hotel/toUpdateHotelAdmin.html?menu=${menu}&pid='+row.pid;
        },
        'click #deleteBtn': function (e, value, row, index) {
			$.messager.confirm("提示", "是否确认删除:"+row.pname, function() {
				...
				$.ajax({
					type:"POST",
					url:"<%=basePath%>hotel/deleteHotelAdmin.html",
					data:{'pid': row.pid},
					dataType: "html",
...
function doSearch(){
    		...
    		var url = "<%=basePath%>hotel/hotelAdminSearchList.html";
