...
<div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li>
				<span style="color: #669FC7;">酒店修改</span>
			</li>
		</ul>
...
<div class="page-content">
	<div class="page-content-area">
        <div class="row">
			<div class="col-md-12">
				<h3 class="header smaller lighter blue">酒店修改</h3>
				<div class="widget-box">
					
					<div class="widget-body">
						<div class="widget-main">
							<form action="<%=basePath%>hotel/updateHotelAdmin.html" id="updateForm" name="updateForm" method="post">
								<%-- 基础信息 --%>
								...
								<div class="row">
									<div class="col-md-12">
										<label class="" > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;酒店描述： </label>
										<div class="clearfix" style="margin-left: 25px;">
										<input id="description" name="description" type="hidden"/>
										
										<script type="text/plain" id="hdescEditor" style="height:240px;width: 85%;"></script>
										</div>
										<!-- 
								...
								<div class="row">
									<div class="col-md-12">
										<label class="" > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;酒店设施： </label>
										<textarea id="hotel_infra" name="hotel_infra" class="form-control" rows="3"  style="width: 83%;margin-left: 25px;">${row.hotel_infra }</textarea>
									</div>
								</div>
								<br>
								<div class="row">
									<div class="col-md-12">
										<label class="" > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;酒店服务： </label>
