...
<div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li>
				<span style="color: #669FC7;">房型修改</span>
			</li>
		</ul>
...
<div class="page-content">
	<div class="page-content-area">
        <div class="row">
			<div class="col-md-12">
				<h3 class="header smaller lighter blue">房型修改</h3>
				<div class="widget-box">
					
					<div class="widget-body">
						<div class="widget-main">
							<form action="<%=basePath%>hotel/updateRoomAdmin.html" id="updateForm" name="updateForm" method="post">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<input id="roomTypeName" name="roomTypeName" value="${row.roomTypeName }" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
									<div class="col-md-6">
										<label class=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;房型状态： </label>
										<select id="roomStatus" name="roomStatus" class="form-control" style="display: inline-block; width: 50%;"/>  
											<option value="0" <c:if test="${row.roomStatus eq '0' }"> selected="selected"</c:if>>有效</option>
											<option value="1" <c:if test="${row.roomStatus eq '1' }"> selected="selected"</c:if>>维修</option>
											<option value="2" <c:if test="${row.roomStatus eq '2' }"> selected="selected"</c:if>>暂停</option>
						                </select>
									</div>
								</div>
								<br>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<textarea id="roomInfra" name="roomInfra" class="form-control" rows="3"  style="width: 83%;margin-left: 25px;">${row.roomInfra }</textarea>
									</div>
								</div>
								<br>
								<div class="row">
									...
									<div class="col-md-6">
										...
										<select id="showInpage" name="showInpage" class="form-control" style="display: inline-block; width: 50%;"/>  
											<option value="0" <c:if test="${row.showInpage eq '0' }"> selected="selected"</c:if>>否</option>
											<option value="1" <c:if test="${row.showInpage eq '1' }"> selected="selected"</c:if>>是</option>
						                </select>
									</div>
								</div>
								<br>
								<div class="row">
									<div class="col-md-6">
										...
										<div style="display: inline-block;   position: relative; top: 8px;">
											<input id="adultCnt" name="adultCnt" value="${row.adultCnt }" type="text" class="input-mini spinner3" value="0" />
										</div>
									</div>
									<div class="col-md-6">
										<label class=""> &nbsp;&nbsp;&nbsp;可入住儿童数： </label>
										<div style="display: inline-block;   position: relative; top: 8px;">
											<input id="childCnt" name="childCnt" value="${row.childCnt }" type="text" class="input-mini spinner3" value="0" />
										</div>
									</div>
								</div>
								<br>
								<div class="row">
									<div class="col-md-6">
										...
										<div style="display: inline-block;   position: relative; top: 8px;">
											<input id="maxExtrabed" name="maxExtrabed" value="${row.maxExtrabed }" type="text" class="input-mini spinner3" value="0" />
										</div>
									</div>
								</div>
								<br>
...
<script type="text/javascript">
	...
	$(function() { 
		attachedImgPreview('${row.roomImg1}');
		$("#attachedImgurl").val('${row.roomImg1}');
