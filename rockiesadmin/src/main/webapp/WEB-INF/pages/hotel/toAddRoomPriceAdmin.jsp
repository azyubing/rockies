			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					  ...
					  <div class="panel-body">
					  		<div class="row">
					  			<div class="col-md-3"><label>酒店名称：</label>${row.pname }</div>
					  			<div class="col-md-3"><label>酒店英文名：</label>${row.panmeEn }</div>
					  			<div class="col-md-3"><label>酒店编号：</label>${row.pid }</div>
					  			<div class="col-md-3"><label>房型名字：</label>${row.roomTypeName }</div>
				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<form action="<%=basePath%>hotel/addRoomPriceAdmin.html" id="addForm" name="addForm" method="post">
