			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					  ...
					  <div class="panel-body">
					  		<div class="row">
					  			<div class="col-md-4"><label>交通包车名称：</label>${row.pname }</div>
					  			<div class="col-md-4"><label>交通包车英文名：</label>${row.pname_en }</div>
					  			<div class="col-md-4"><label>交通包车编号：</label>${row.pid }</div>
					  		</div>
					  </div>
				</div>
			</div>
				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<form action="<%=basePath%>traffic/addTrafficCharteredPriceAdmin.html" id="addForm" name="addForm" method="post">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<input id="carbrand" name="carbrand" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
									<div class="col-md-6">
										<label class=""> &nbsp;&nbsp;&nbsp;最大乘坐人数： </label>	
										<div style="display: inline-block;   position: relative; top: 8px;">
											<input id="maxpeople" name="maxpeople" type="text" class="input-mini spinner3" value="0" />
										</div>
									</div>
								</div>
								<br>
								<div class="row">
									<div class="col-md-6">
										...
										<input id="validStarttime" name="validStarttime" onblur="checkStartTimeRepeat()" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
										<span style="color: red;">*格式如:09:30</span>
									</div>
									<div class="col-md-6">
										<label class=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;结束时间：</label>
										<input id="validEndtime" name="validEndtime" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
										<span style="color: red;">*格式如:09:30</span>
									</div>
								</div>
								<br>
								...
								<div class="row">
									<div class="col-md-6">
										<label class=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;包车时长(小时)： </label>
										<input id="hourCnt" name="hourCnt" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
									<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-12">
										...
										<textarea id="luggage" name="luggage" class="form-control" rows="3"  style="width: 83%;margin-left: 25px;"></textarea>
									</div>
								</div>
								<br>
...
<script type="text/javascript">
	...
	$(function() { 
		...
		$("#addBtn").click(function(){
			...
			if($("#validEndtime").val() == null || $("#validEndtime").val().trim() == "" || $("#validEndtime").val().indexOf(':') != 2){
				alert("请输入项目格式为“18:00”的价格有效结束时间！");
				return false;
			}
	...
	function checkStartTimeRepeat(){
		...
		$.ajax({
			type:"GET",
			url:"<%=basePath%>traffic/checkStartTimeRepeat.html",
			data:{'pid': $("#pid").val(),'carbrand': $("#carbrand").val(),'validStarttime': $("#validStarttime").val() },
			dataType: "html",
