				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<form action="<%=basePath%>traffic/updateTrafficAdmin.html" id="updateForm" name="updateForm" method="post">
								<%-- 基础信息 --%>
								...
								<div class="row">
									<div class="col-md-6">
										...
										<input id="startplace" name="startplace" value="${row.startplace }" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
									<div class="col-md-6">
										<label class=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;终点： </label>
										<input id="endplace" name="endplace" value="${row.endplace }" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
								</div>
								 -->
								<br>
								<div class="row">
									<div class="col-md-6">
										...
										<select id="traffic_type" name="traffic_type" class="form-control" style="display: inline-block; width: 50%;"/>  
											<option value="" <c:if test="${row.traffic_type eq '' }"> selected="selected"</c:if>>-请选择-</option>
											<option value="0" <c:if test="${row.traffic_type eq 0 }"> selected="selected"</c:if>>包车</option>
										<!-- 	<option value="1" <c:if test="${row.traffic_type eq 1 }"> selected="selected"</c:if>>班车</option> -->
								        </select>
									</div>
									<div class="col-md-6">
										<label class=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用车等级： </label>
										<select id="carlvl" name="carlvl" class="form-control" style="display: inline-block; width: 50%;"/>  
											<option value="" <c:if test="${row.carlvl eq '' }"> selected="selected"</c:if>>-请选择-</option>
											<option value="0" <c:if test="${row.carlvl eq 0 }"> selected="selected"</c:if>>豪华</option>
											<option value="1" <c:if test="${row.carlvl eq 1 }"> selected="selected"</c:if>>舒适</option>
											<option value="2" <c:if test="${row.carlvl eq 2 }"> selected="selected"</c:if>>普通</option>
								        </select>
									</div>
								</div>
								<br>
								<div class="row">
									<div class="col-md-6">
										...
										<select id="cartype" name="cartype" class="form-control" style="display: inline-block; width: 50%;"/>  
											<option value="" <c:if test="${row.cartype eq '' }"> selected="selected"</c:if>>-请选择-</option>
											<option value="0" <c:if test="${row.cartype eq 0 }"> selected="selected"</c:if>>4人以下</option>
											<option value="1" <c:if test="${row.cartype eq 1 }"> selected="selected"</c:if>>5-7人坐</option>
											<option value="2" <c:if test="${row.cartype eq 2 }"> selected="selected"</c:if>>7-20人坐</option>
											<option value="3" <c:if test="${row.cartype eq 3 }"> selected="selected"</c:if>>20人以上</option>
								        </select>
									</div>
									<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<select id="traff_kind" name="traff_kind" class="form-control" style="display: inline-block; width: 50%;"/>  
											<option value="" <c:if test="${row.traff_kind eq '' }"> selected="selected"</c:if>>-请选择-</option>
											<option value="0" <c:if test="${row.traff_kind eq 0 }"> selected="selected"</c:if>>车</option>
											<option value="1" <c:if test="${row.traff_kind eq 1 }"> selected="selected"</c:if>>船</option>
											<option value="2" <c:if test="${row.traff_kind eq 2 }"> selected="selected"</c:if>>飞机</option>
								        </select>
									</div>
								</div>
								<br>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<input id="map_address_start" name="map_address_start" value="${row.map_address_start }" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
								</div>
								<br>
								<div class="row">
									<div class="col-md-6">
										...
										<input id="map_start_lng" name="map_start_lng" value="${row.map_start_lng }" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
									<div class="col-md-6">
										<label class=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;出发点纬度： </label>
										<input id="map_start_lat" name="map_start_lat" value="${row.map_start_lat }" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
								</div>
								<br>
								<div class="row">
									<div class="col-md-12">
										...
										<input id="map_address_end" name="map_address_end" value="${row.map_address_end }" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
								</div>
								<br>
								<div class="row">
									<div class="col-md-6">
										...
										<input id="map_end_lng" name="map_end_lng" value="${row.map_end_lng }" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
									<div class="col-md-6">
										<label class=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;终点纬度： </label>
										<input id="map_end_lat" name="map_end_lat" value="${row.map_end_lat }" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
									</div>
								</div>
								<br>
								 -->
