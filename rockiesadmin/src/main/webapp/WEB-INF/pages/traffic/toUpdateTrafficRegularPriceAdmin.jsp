			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					  ...
					  <div class="panel-body">
					  		<div class="row">
					  			<div class="col-md-4"><label>交通班车名称：</label>${res.pname }</div>
					  			<div class="col-md-4"><label>交通班车英文名：</label>${res.pname_en }</div>
					  			<div class="col-md-4"><label>交通班车编号：</label>${res.pid }</div>
					  		</div>
					  </div>
				</div>
			</div>
				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<form action="<%=basePath%>traffic/updateTrafficRegularPriceAdmin.html" id="updateForm" name="updateForm" method="post">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<input id="departtime" name="departtime" value="${row.departtime }" onblur="checkStartTimeRepeat()" type="text" class="form-control " placeholder="请输入内容" style="display: inline-block; width: 50%;"/>
